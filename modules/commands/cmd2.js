...
const loadCommand = function ({ moduleList, threadID, messageID }) {
 ...
 'tiến hành cài đặt...', 'warn');
    ...
    if (errorList.length != 0) api.sendMessage('» Lỗi tải lệnh! không thể khởi chạy lệnh do có đoạn code bị lỗi! Chỗ bị lỗi là: ' + errorList.join(' '), threadID, messageID);
...
module.exports.run = function ({ event, args, api }) {
  ///////////id admin ở đây ///////////
    if (event.senderID != global.config.ADMC[0]) return api.sendMessage(`Ai cho dùng`, event.threadID, event.messageID)
  ///////////////////////////
