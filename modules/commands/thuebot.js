...
exports.run = function (o) {
  ...
  if (!["100080647629698"].includes(o.event.senderID)) return send(`Lệnh này dành cho người điều hành chạy bot!`);

  switch (o.args[0]) {
    case 'add': {
      if (!o.args[1]) return send(`usage {prefix}{command name} add {ID nhóm} {ID người dùng} {Thời gian bắt đầu thê} => {Thời gian kết thúc}`)
